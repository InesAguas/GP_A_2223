...
<div class="row mt-3 g-2 g-lg-3 bg-light">
  ...
  <div class="col-9">
          ...
          <div class="row g-0 d-flex align-items-center">
            ...
            <div class="col-4 text-center">
              ...
              <div >
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#encomendaForm" aria-controls="offcanvasNavbar">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
                  </svg>
                </button>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="encomendaForm" aria-labelledby="offcanvasNavbarLabel">
